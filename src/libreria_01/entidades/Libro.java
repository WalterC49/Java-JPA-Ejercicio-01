...
public class Libro {
    ...
    public String toString() {
        return "isbn=" + isbn + ", titulo=" + titulo + ", anio=" + anio + ", ejemplares=" + ejemplares + ", ejemplaresPrestados=" + ejemplaresPrestados + ", ejemplaresRestantes=" + ejemplaresRestantes + ", alta=" + alta
                + "\nautor=" + autor
                + "\neditorial=" + editorial;
    }
}
